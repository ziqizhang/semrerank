...
def calc_avg_advancement(base_ate_outlist_json, srr_ate_outlist_json, term_filter_list_file):
...
#save to a csv file
def calc_advancement_stats(base_ate_outlist_folder, srr_ate_outlist_folder, term_filter_list_file,
                           out_file_csv):
    ...
    with open(out_file_csv, 'w', newline='') as csvfile:
        ...
        for base_ate_json in os.listdir(base_ate_outlist_folder):
            ...
            stats = calc_avg_advancement(base_ate_outlist_folder+"/"+base_ate_json,
                                         srr_ate_outlist_folder+"/"+ssr_ate_json,
                                         term_filter_list_file)
            values=[]
...
if __name__ == "__main__":
    ...
    # >>> code for calculating advancement stats by semrerank
    ...
    # calc_advancement_stats(base_ate_outfolder, ssr_ate_outfolder, filter_terms_file,output_csv)
